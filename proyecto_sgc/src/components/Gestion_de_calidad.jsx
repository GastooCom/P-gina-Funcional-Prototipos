  ...
  return (
    ...
    <div className="fundamentos-container">
      ...
      {/* <div className="icono-final">
        <img src="ruta/de/la/imagen.jpg" alt="Descripción simbólica" />
      </div> */}
      ...
      <section className="section">
        ...
        <ul>
          ...
          <li><strong>Pruebas de integración:</strong>Verfican que los módulos funcionen correctamente al interactuar entre sí.</li>
        ...
        <ul>
          ...
          <li>
            ...
            <ul>
              ...
              <li>Ejemplos: partición de equivalencia, valores limite, tablas de decisión, pruebas de casos de uso.</li>
            </ul>
          </li>
          <li>
      ...
      <div className="bloque desarrollo">
        ...
        <p>Aplicaciones o plataformas que apoyan a los equipos en la verificacion, validación y mejora continua del producto.</p>
